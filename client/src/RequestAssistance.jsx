...
// "Would you like any assistance with the following?" section, broken out so
// it can stand alone on its own screen. Controlled: the parent owns `selected`
// (a map of category -> bool) and handles `onToggle`.
...
export default function RequestAssistance({
  ...
  selected = {},
  onToggle,
  label = 'WOULD YOU LIKE ANY ASSISTANCE WITH THE FOLLOWING?',
  accentColor = '#22d3ee',
}) {
  return (
